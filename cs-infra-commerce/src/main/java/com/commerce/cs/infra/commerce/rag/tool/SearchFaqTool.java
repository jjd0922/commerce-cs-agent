...
public class SearchFaqTool implements ToolHandler {
    ...
    public String description() {
        return "Search FAQ documents for general customer support questions.";
    }
    ...
    public ToolResult execute(Map<String, Object> args, ChatContext context) {
        return ToolResult.success(Map.of("answers", toResponse(ragSearchService.search(RagCollection.FAQ, query(args)))));
    }
